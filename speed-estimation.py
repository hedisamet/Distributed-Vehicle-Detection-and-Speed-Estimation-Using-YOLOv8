...
def main(video_path, json_path, output_video_path):
    ...
    print(f"Input Video URL: file:///{os.path.normpath(os.path.abspath(video_path))}")
    print(f"JSON Output URL: file:///{os.path.normpath(os.path.abspath(json_path))}")
    print(f"Output Video URL: file:///{os.path.normpath(os.path.abspath(output_video_path))}")
...
video_path = "C:\\Users\\21697\\OneDrive\\Bureau\\fog\\sample_video.mp4"
json_path = "C:\\Users\\21697\\OneDrive\\Bureau\\fog\\output_data.json"
output_video_path = "C:\\Users\\21697\\OneDrive\\Bureau\\fog\\output_video.mp4"

main(video_path, json_path, output_video_path)
